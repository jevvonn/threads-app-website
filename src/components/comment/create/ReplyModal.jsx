      ...
      <div className="modal">
        <div className="modal-box max-w-xl p-4 absolute top-9 flex flex-col gap-2">
          ...
          <div className=" flex justify-end">
            <button
              className="px-4 py-2 bg-primary text-sm text-white font-semibold capitalize tracking-wider rounded-full border-2 border-primary hover:bg-[#554f95] transition"
              disabled={isLoading}
